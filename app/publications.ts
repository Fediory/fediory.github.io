...
export const publications: Publication[] = [
  ...
  },
  {
    ...
    authors: "Xiaoning Liu, Zongwei Wu, Florin-Alexandru Vasluianu, Yixu Feng, et al.",
    venue: "CVPR Workshops 2025 (NTIRE)",
    note: "Challenge report · Co-author",
    description: "A comprehensive report of the NTIRE 2025 low-light enhancement challenge, including participating methods and final results.",
  ...
  },
  {
    ...
    authors: "Sangmin Lee, Eunpil Park, Angel Canelo, Yixu Feng, et al.",
    venue: "CVPR Workshops 2025 (NTIRE)",
    note: "Challenge report · Co-author",
    description: "A challenge overview for efficient multi-frame HDR and restoration under strict parameter and compute budgets.",
    link: "https://arxiv.org/abs/2505.12089",
  },
  {
    title: "NTIRE 2024 Challenge on Low Light Image Enhancement: Methods and Results",
    authors: "Radu Timofte, Xiaoning Liu, Yixu Feng, et al.",
    venue: "CVPR Workshops 2024 (NTIRE)",
    note: "Challenge report · Co-author",
    description: "A report on the NTIRE 2024 low-light enhancement challenge and its benchmarked solutions.",
