...
export const publications: Publication[] = [
  ...
  },
  {
    ...
    titleZh: "Copper-Policy：聚焦表征学习，实现鲁棒机器人操作",
    authors: "Zexin Feng, Yixu Feng, Lingyu Xiao, Shang Su, Kexin Zheng, Chang Xu, Mengkai Shi, Shuo Feng, Xintao Yan",
    venue: "arXiv submission · 2026",
    venueZh: "已提交 arXiv · 2026",
    note: "Second author · Submitted",
    noteZh: "第二作者 · 已投稿",
    description: "Jointly learns a compact world representation and robot policy through temporal joint-embedding prediction, improving robust manipulation without pixel-level future generation.",
    descriptionZh: "通过时序联合嵌入预测，共同学习紧凑的世界表征与机器人策略；无需生成像素级未来画面，也能提升机器人操作的鲁棒性。",
    link: "https://zexinfeng-cn.github.io/works/copper-policy/assets/copper-policy-paper.pdf",
    paperPageHref: "https://zexinfeng-cn.github.io/works/copper-policy/",
    image: "/publication-images/copper-policy.png",
    imageAlt: "Copper-Policy compact world representation and action generation overview",
  },
  {
