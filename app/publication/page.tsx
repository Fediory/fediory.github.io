...
export default function PublicationsPage() {
  return (
    <main>
      <header className="top-nav"><nav className="nav-inner" aria-label="Primary navigation"><a href="/">Homepage</a><a className="active" href="/publication">Publications</a><a href="/#education">Education</a><a href="/#internship">Internship</a><a href="/#reviewing">Reviewing</a><a href="/#awards">Honors</a><a href="/project">Projects</a></nav></header>
      <div className="site-wrap publication-page">
        <section className="publication-hero"><p className="eyebrow">RESEARCH OUTPUT</p><h1>Publications</h1><p>A selected list of research papers and workshop honors in embodied AI, vision-language-action systems, and low-light image enhancement.</p><div className="publication-stats"><span><strong>{publications.length}</strong> records</span><span><strong>2</strong> main-track papers</span><span><strong>3</strong> workshop honors</span></div></section>
